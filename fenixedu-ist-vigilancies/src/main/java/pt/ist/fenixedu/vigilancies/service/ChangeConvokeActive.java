...
public class ChangeConvokeActive {
    ...
    private static void sendEmailNotification(Boolean bool, Person person, Vigilancy convoke) {
        ...
        new Message(person.getSender(), new ConcreteReplyTo(replyTo).asCollection(), Collections.singletonList(VigilancyGroup
                .get(convoke)), Collections.EMPTY_LIST, Collections.EMPTY_LIST, subject, emailMessage,
                convoke.getSitesAndGroupEmails());
